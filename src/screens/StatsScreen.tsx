			...
			>
				<View style={styles.hero}>
					...
					<Text style={styles.title}>
						Теперь это уже не просто карточки, а тренажер
					</Text>
				...
				>
					<View style={styles.summaryTopRow}>
						...
						<View style={styles.summaryBadge}>
							...
							<Text style={styles.summaryBadgeText}>Level {stats.level}</Text>
						</View>
					</View>
				...
				>
					...
					<BreakdownRow
						...
						value={stats.known}
						width={
							`${(stats.known / Math.max(stats.total, 1)) * 100}%` as `${number}%`
						}
					/>
					<BreakdownRow
						color="#f4a261"
						...
						value={stats.review}
						width={
							`${(stats.review / Math.max(stats.total, 1)) * 100}%` as `${number}%`
						}
					/>
					<BreakdownRow
						color="#5f7698"
				...
				>
					...
					<View style={styles.tipCard}>
						...
						<Text style={styles.tipText}>
							Сначала закрывайте дневную цель, потом проходите 3-4 карточки в
							режиме ручного ответа. Такой ритм дает и объем, и качество.
						</Text>
					</View>
				</View>
	...
	return (
		<View style={styles.breakdownRow}>
			...
			<View style={styles.breakdownTrack}>
				<View
					style={[styles.breakdownFill, { backgroundColor: color, width }]}
				/>
			</View>
		</View>
	);
